...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pageimages_defaultimage', (
        ...
        db.send_create_signal(u'pageimages', ['DefaultImage'])


    def backwards(self, orm):
        # Deleting model 'DefaultImage'
        db.delete_table(u'pageimages_defaultimage')
